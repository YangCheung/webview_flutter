...
class WebViewController {
  ...
  ValueChanged<int> _onProgressChanged;
  ValueChanged<String> _onTitle;

  Future<void> _onMethodCall(MethodCall call) async {
    switch (call.method) {
      case 'onProgressChanged':
        if(_onProgressChanged != null) _onProgressChanged(call.arguments);
        break;
      case 'onReceivedTitle':
        if(_onTitle != null) _onTitle(call.arguments);
        break;
