...
public class FlutterWebView implements PlatformView, MethodCallHandler {
  ...
  FlutterWebView(Context context, BinaryMessenger messenger, int id, Map<String, Object> params) {
    ...
    String ua = "tigerobo_stock_app " + webView.getSettings().getUserAgentString();
    ...
    webView.setWebChromeClient(new WebChromeClient() {
      ...
      public void onReceivedTitle(WebView view, String title) {
        methodChannel.invokeMethod("onReceivedTitle", title);
      }

      public void onProgressChanged(WebView view, int progress) {
        methodChannel.invokeMethod("onProgressChanged", progress);
      }
    });
    ...
    webView.setWebViewClient(new WebViewClient(){
      ...
      public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
        methodChannel.invokeMethod("onProgressChanged", null);
      }
